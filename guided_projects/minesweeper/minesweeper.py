...
class Board:
    def __init__(self, dim_size, num_bombs):
        # lets keep track of these parameters. they'll be helpful later on
        ...
        # we'll save (row,col) tupes into this set
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            ...
            row = loc // self.dim_size # we want the number of times dim_size goes into loc to tell us what ro to look at
            col = loc % self.dim_size # we want the remainder to tell us what index in that row to look at

            if board[row][col] == '*':
                # this meas we've actually planted a bomb there already, so keep going
                continue
    ...
    def assign_values_to_board(self):
        ...
        # represents how many neighbouring bombs there are. we can precomputer and it'll save us some effort
        # checking what's around the board later on :)
        for r in range(self.dim_size):
            for c in range(self.dim_size):
                if self.board[r][c] == '*':
                    # if this is already a bomb, we dont want to calculate anything
                    continue
    ...
    def dig(self, row, col):
        ...
        # dig at a location with no neighbouring bombs -> recursively dig neigbours
        ...
        # if our initial dig didnt hit a bomb, we *shouldn't hit a bomb here
        return True
    ...
    def __str__(self):
        ...
        # first let's create a new array taht represents what the user would see
